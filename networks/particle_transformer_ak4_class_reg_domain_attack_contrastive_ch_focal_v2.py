...
####
class FocalCrossEntropyContrastiveRegDomainAttack(torch.nn.L1Loss):
    __constants__ = ['reduction','loss_reg','loss_res','quantiles','loss_da','domain_weight','domain_dim','loss_attack','temperature','loss_cont','focal_gamma']
    ...
    def __init__(self, 
        ...
        super(FocalCrossEntropyContrastiveRegDomainAttack, self).__init__(None, None, reduction)
    ...
    def forward(self, 
        ...
        if input_cat.nelement():            
            ...
            loss_cat = ce_loss*((1-torch.exp(-ce_loss))**self.focal_gamma)
...
def get_loss(data_config, **kwargs):
    ...
    return FocalCrossEntropyContrastiveRegDomainAttack(
