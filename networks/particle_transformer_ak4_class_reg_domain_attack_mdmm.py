...
def get_loss(data_config, **kwargs):
    ...
    return CrossEntropyLogCoshLossDomainAttack(
        ...
        mdmm_reg_value=kwargs.get('mdmm_reg_value',0.3), ## target is 0 for regression
        mdmm_q_scale=kwargs.get('mdmm_q_scale',1.),
        mdmm_q_value=kwargs.get('mdmm_q_value',0.2), ## target is 0 for regression
        mdmm_da_scale=kwargs.get('mdmm_da_scale',1.),
        mdmm_da_value=kwargs.get('mdmm_da_value',0.75), ## target value is 0 for CELoss 
        mdmm_attack_scale=kwargs.get('mdmm_attack_scale',1.),
        mdmm_attack_value=kwargs.get('mdmm_attack_value',0.01), ## target is 0 for attack KL
        quantiles=quantiles,
